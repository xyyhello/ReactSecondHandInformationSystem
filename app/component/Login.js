...
import { showloginbox , dologin,showregistbox} from '../action/Action.js';
				...
				<form id="login_form" className="form-login" action="index.html" onClick={(event)=>{event.stopPropagation();}}>
				    ...
				    <div className="login-wrap">
				        ...
				        <div className="registration">
				            没有账号？<br />
				            <a className="" href="javascript:;" onClick={()=>{this.props.showregistbox(true);this.props.showloginbox(false)}}>
				                创建账号
				            </a>
				        </div>
			    	</div>
